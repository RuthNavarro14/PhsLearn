        ...
        <div className="single-item">
          <div className="row">
            <div className="col-md-6">
              ...
              <h4>New to Pilar High School?</h4>
                              <p>
                                Check out the official student link below first
                                semester of AY 23–24 orientation to get you
                                knowledgeable about the modality, Guidelines and
                                necessary PHS essentials!
                              </p>
                <button>
                  <a
                    style={{ color: 'white', textDecoration: 'none' }}
                    href="https://youtu.be/w-kNTAU53-Y?si=Lvza9-LBbG7lchBv"
                    target="_blank"
            ...
            <div className="col-md-6">
              <div className="profile">
                <div className="image-area">
                  <img src={require(`./Photos/virtual.webp`)} alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="content2">
              <h4 style={{ marginTop: '30px' }}>
                <strong>  EDUCATE. LEARN. DEVELOP</strong>
              </h4>
              <p>
                                Visit PHSLearn to discover the innovative
                                digital<br />
                                teaching and learning approach of Pilar High
                                School.
                              </p>
            </div>
          </div>
          <div className="col-md-6">
            <div className="profile">
              <div className="image-area">
                <img
                  src={require(`./Photos/shs pics.jpg`)}
                  alt=""
                />
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="content2" style={{ marginTop: '30px' }}>
              <h4> <strong> A little late from class?</strong>?</h4>
              <p>
                                If you're missing some classes in PHSLearn,
                                <br />fillout this form and we'll help you sort
                                it out.
                              </p>
      ...
      <div className="single-item">
        <div className="row">
          <div className="col-md-6">
            <div className="content2" style={{ marginTop: '30px' }}>
            <p>
                                Hey everyone! <br />Exciting news: Pilar High
                                School now features a collection of free online
                                books for you to dive into. Explore various
                                genres and topics right from your LMS dashboard.
                                Happy reading!
                              </p>
              <Link to="/Books">
